...
public class LASemanticoUtils {
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, LAParser.Exp_aritmeticaContext ctx) {
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, LAParser.TermoContext ctx) {
        // A variável que será retornada ao fim da execução é inicializada com o tipo
        // do primeiro elemento que será verificado, para fins de comparação.
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, LAParser.FatorContext ctx) {
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, LAParser.ParcelaContext ctx) {
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, LAParser.Parcela_unarioContext ctx) {
        TipoT3 tipoRetorno;
        String nome;
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, LAParser.Parcela_nao_unarioContext ctx) {
        TipoT3 tipoRetorno;
        String nome;
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, LAParser.ExpressaoContext ctx) {
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, LAParser.Termo_logicoContext ctx) {
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, LAParser.Fator_logicoContext ctx) {
        TipoT3 tipoRetorno = verificarTipo(tabela, ctx.parcela_logica());
        return tipoRetorno;

    }

    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, LAParser.Parcela_logicaContext ctx) {
        TipoT3 tipoRetorno;
